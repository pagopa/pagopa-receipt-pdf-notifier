...
public class EUCovidCert {
  ...
  public EUCovidCert authCode(String authCode) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    EUCovidCert euCovidCert = (EUCovidCert) o;
    return Objects.equals(this.authCode, euCovidCert.authCode);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to EUCovidCert
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EUCovidCert.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EUCovidCert is not found in the empty JSON string", EUCovidCert.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!EUCovidCert.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EUCovidCert` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EUCovidCert.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EUCovidCert.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EUCovidCert' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EUCovidCert> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EUCovidCert.class));

       return (TypeAdapter<T>) new TypeAdapter<EUCovidCert>() {
           @Override
           public void write(JsonWriter out, EUCovidCert value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EUCovidCert read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of EUCovidCert given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EUCovidCert
  * @throws IOException if the JSON string is invalid with respect to EUCovidCert
  */
  public static EUCovidCert fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EUCovidCert.class);
  }

 /**
  * Convert an instance of EUCovidCert to an JSON string
  *
  * @return JSON string
  */
