...
public class PrescriptionData {
  public static final String SERIALIZED_NAME_NRE = "nre";
  @SerializedName(SERIALIZED_NAME_NRE)
  private String nre;

  public static final String SERIALIZED_NAME_IUP = "iup";
  @SerializedName(SERIALIZED_NAME_IUP)
  private String iup;

  public static final String SERIALIZED_NAME_PRESCRIBER_FISCAL_CODE = "prescriber_fiscal_code";
  @SerializedName(SERIALIZED_NAME_PRESCRIBER_FISCAL_CODE)
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.nre, prescriptionData.nre) &&
        Objects.equals(this.iup, prescriptionData.iup) &&
  ...
  static {
    ...
    openapiFields.add("iup");
    openapiFields.add("prescriber_fiscal_code");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PrescriptionData
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PrescriptionData.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PrescriptionData is not found in the empty JSON string", PrescriptionData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!PrescriptionData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PrescriptionData` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PrescriptionData.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      if (!jsonObj.get("nre").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("iup") != null && !jsonObj.get("iup").isJsonNull()) && !jsonObj.get("iup").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `iup` to be a primitive type in the JSON string but got `%s`", jsonObj.get("iup").toString()));
      }
      if ((jsonObj.get("prescriber_fiscal_code") != null && !jsonObj.get("prescriber_fiscal_code").isJsonNull()) && !jsonObj.get("prescriber_fiscal_code").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `prescriber_fiscal_code` to be a primitive type in the JSON string but got `%s`", jsonObj.get("prescriber_fiscal_code").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PrescriptionData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PrescriptionData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PrescriptionData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PrescriptionData.class));

       return (TypeAdapter<T>) new TypeAdapter<PrescriptionData>() {
           @Override
           public void write(JsonWriter out, PrescriptionData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PrescriptionData read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of PrescriptionData given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PrescriptionData
  * @throws IOException if the JSON string is invalid with respect to PrescriptionData
  */
  public static PrescriptionData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PrescriptionData.class);
  }

 /**
  * Convert an instance of PrescriptionData to an JSON string
  *
  * @return JSON string
  */
